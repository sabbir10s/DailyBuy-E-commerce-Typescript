...
const MyAccount = () => {
  ...
  const { firstName, lastName, email, mobile, address, country, state, city } =
    data;
  return (
        ...
        <form className="p-5 w-full lg:w-3/4">
          <div className=" grid grid-cols-1 lg:grid-cols-2 gap-[25px] lg:gap-[90px]">
            <div>
              ...
              {!active && (
                <p className="font-semibold mt-[5px] capitalize">{firstName}</p>
              )}
              {active && (
                <input
            ...
            <div>
              ...
              {!active && (
                <p className="font-semibold mt-[5px] capitalize">{lastName}</p>
              )}
              {active && (
                <input
                  className="mt-[5px] capitalize border-[1px] border-[#919EAB]/30 focus:outline-primary-600 rounded-[5px] py-[10px] px-[14px] w-full"
          ...
          <div className=" grid grid-cols-1 lg:grid-cols-2 gap-[25px] lg:gap-[90px] mt-[24px]">
            <div>
              ...
              {!active && (
                <p className="font-semibold mt-[5px] capitalize">{email}</p>
              )}
              {active && (
                <input
                  className="mt-[5px] capitalize border-[1px] border-[#919EAB]/30 focus:outline-primary-600 rounded-[5px] py-[10px] px-[14px] w-full"
            ...
            <div>
              ...
              {!active && (
                <p className="font-semibold mt-[5px] capitalize">{mobile}</p>
              )}
              {active && (
                <input
                  className="mt-[5px] capitalize border-[1px] border-[#919EAB]/30 focus:outline-primary-600 rounded-[5px] py-[10px] px-[14px] w-full"
          ...
          <div className=" grid grid-cols-1 lg:grid-cols-2 gap-[25px] lg:gap-[90px] mt-[24px]">
            <div>
              ...
              {!active && (
                <p className="font-semibold mt-[5px] capitalize">{address}</p>
              )}
              {active && (
                <input
                  className="mt-[5px] capitalize border-[1px] border-[#919EAB]/30 focus:outline-primary-600 rounded-[5px] py-[10px] px-[14px] w-full"
            ...
            <div>
              ...
              {!active && (
                <p className="font-semibold mt-[5px] capitalize">{country}</p>
              )}
              {active && (
                <input
                  className="mt-[5px] capitalize border-[1px] border-[#919EAB]/30 focus:outline-primary-600 rounded-[5px] py-[10px] px-[14px] w-full"
          ...
          <div className=" grid grid-cols-1 lg:grid-cols-2 gap-[25px] lg:gap-[90px] mt-[24px]">
            <div>
              ...
              {!active && (
                <p className="font-semibold mt-[5px] capitalize">{state}</p>
              )}
              {active && (
                <input
                  className="mt-[5px] capitalize border-[1px] border-[#919EAB]/30 focus:outline-primary-600 rounded-[5px] py-[10px] px-[14px] w-full"
            ...
            <div>
              ...
              {!active && (
                <p className="font-semibold mt-[5px] capitalize">{city}</p>
              )}
              {active && (
                <input
                  className="mt-[5px] capitalize border-[1px] border-[#919EAB]/30 focus:outline-primary-600 rounded-[5px] py-[10px] px-[14px] w-full"
