  ...
  return (
    <>
      <div className="container mt-[80px] lg:mt-1">
        <h2 className=" text-2xl lg:text-[48px] font-semibold mt-[30px] md:mt-[40px] ">
          Your Wishlist
        </h2>
        <div className="mt-8">
            ...
            {wishList.length > 0 && (
              <div>
                <div className=" hidden lg:grid grid-cols-7 gap-4">
                  <h2 className="col-span-3  font-semibold py-5 uppercase">
                    Product
                  </h2>
                  ...
                  <h2 className="font-semibold py-5 uppercase text-center">
                    Remove
                  </h2>
                </div>
