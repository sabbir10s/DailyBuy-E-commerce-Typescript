...
const ShoppingItems = ({ item }: CartProps) => {
  ...
  return (
    <div className="bg-white hover:bg-gray-50 border-b-[0.5px] cursor-pointer p-2">
        ...
        <div className="w-full col-span-4">
          ...
          <div className=" grid grid-cols-3 items-center w-full">
            ...
            <div className="flex items-center justify-center gap-1">
              ...
              <span className="px-2 lg:text-base font-medium">
                {cartQuantity}
              </span>
            ...
            <button
              ...
              className="p-2 lg:p-4 flex justify-end"
            >
              {" "}
              <svg
